...
public class PropertiesDiffToolCommand implements Command {
    ...
    void generateTempPropertiesFile(List<PropertyDiffDetail> diffDetailList, Source source, Writer writer) throws IOException {
    ...
    Path generateTempPropertiesFile(List<PropertyDiffDetail> diffDetailList, Source source, String sourceFile) throws IOException {
